...
ax.plot(bins['summed'], bins['fluct'], 'o', color=colors['red'], ms=1.5, label='50 events / bin')
ax.plot(summed_range, alpha_mean * summed_range, lw=0.75, color=colors['red'], label=r'$\alpha$ ' + f'= {int(alpha_mean)} ± {int(alpha_std)}\n  [a.u. / LacI]')

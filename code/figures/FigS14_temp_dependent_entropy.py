...
independent_params = pd.read_csv('../../data/pooled_entropic_parameter_samples.csv', comment='#')
dependent_params = pd.read_csv('../../data/pooled_entropic_parameter_temp_dependence_samples.csv', comment='#')
...
plt.savefig('../../figs/FigS14_temp_dependent_entropy.pdf', facecolor='white', bbox_inches='tight')

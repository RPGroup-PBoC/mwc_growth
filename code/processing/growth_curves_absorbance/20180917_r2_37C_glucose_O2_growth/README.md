...
# 2018-09-17 Growth Measurement (Run 2)
...
| :------  | :------ | :------- | ----------: | --------: |
| activation 1 - pos. 9 | ` ` | `xapABR<>kd4-FRT:Kan:FRT` |  MG1655 |`deltaXAP` |
...
## Notes & Observations
* Inoculum OD<sub>600nm</sub> was ~ 0.38 and was diluted 1:10 into the growth medium.
* The run was started at 08h50m.

## Analysis Files

![](output/20180917_r2_37C_glucose_O2_growth.png)

...
**Status:**  REJECTED <br/>
This dataset has some hiccups with the imaging conditions. There was an issue in imaging the various ATC concentrations. See notes and observations </div>

## Purpose
This experiment served as another test of using a Hg lamp for illumination.
...
* These cells sat at room temperature for ~1 hour while the same cells were imaged on another microscope.
* There was human error in marking the positions for some pads, resulting in mixed up samples. For this reason, the dataset was rejected.

## Analysis Files

**Calibration Factor Determination**
![](output/20180213_hermes_37C_glucose_O2_calibration_factor.png)


**Fold-change**
![](output/20180213_hermes_37C_glucose_O2_foldchange.png)

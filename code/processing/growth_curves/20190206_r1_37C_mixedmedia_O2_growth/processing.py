...
carbon_wells = {**{alphanumeric_map[f'{row}{col}']:'glucose' for row in ['B','E'] for col in np.arange(3, 11, 1)}, 
                **{alphanumeric_map[f'{row}{col}']:'glycerol' for row in ['C','F'] for col in np.arange(3, 11, 1)},
                **{alphanumeric_map[f'{row}{col}']:'acetate' for row in ['D','G'] for col in np.arange(3, 11, 1)}}

---
status: Rejected 
reason: ATC Titration is suspicious -- no clear trend of increasing copy number with increasing ATC
---
...
## Notes & Observations
* During imaging, I noticed that the cells were very bright in YFP, with some cells expressing similarly to the `delta` strain. This is confirmed by the analysis files (below) which show that there was some problem in the ATC induction series.

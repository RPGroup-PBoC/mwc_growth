...
## Notes & Observations
* Cells were harvested at OD<sub>600nm</sub>s 0.3-0.53.
* Some positions on the growth movie seem 'wet', but the data seems usable.
...
3. Tubes were placed in a rack and covered with a plastic box to protect from photocleavage of ATC. Cells were allowed to grow for 7.5 hours at 37°C with shaking at ~ 220 RPM.

4. Once the cells reached an OD<sub>600nm</sub> between 0.3 - 0.53, the cells were removed from the warm room and harvested.

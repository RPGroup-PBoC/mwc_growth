...
# 2019-03-16 37C Glycerol O2 Dilution
...
## Notes & Observations
* Cells were harvested at OD_600nm between 0.18-0.28, except the 10ng/mL `dilution` culture which was 0.13.
...
3. Tubes were placed in a rack and covered with a plastic box to protect from photocleavage of ATC. Cells were allowed to grow for 21 hours at 37°C with shaking at ~ 220 RPM.

4. Once the cells reached an OD<sub>600nm</sub> between 0.13 - 0.28, the cells were removed from the warm room and harvested.

...
growth_df = mwc.process.morphological_filter(growth_df, area_bounds=[1, 8], ip_dist= IP_DIST)
...
auto_df = mwc.process.morphological_filter(auto_df, area_bounds=[1, 8], ip_dist=IP_DIST)

...
## Notes & Observations
* Cells were harvested at OD<sub>600nm</sub> 0.22-0.42.
* The first position in the growth movie looks 'wet', but the rest look fine.
* 200µL of each `dilution` sample were added to the mixture, rather than 100µL.

...
## Notes & Observations
* The `autofluorescence` strain was more dense than the other samples and was diluted 1:3 during the course of growth to adjust it.
...
1. A 100µL aliquot of each of the `dilution` samples from varying ATC concentrations were combined in a 1.5mL eppendorf tube.

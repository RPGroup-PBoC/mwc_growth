...
growth_df.to_csv(
    'output/{}_{}_{}C_{}_{}_growth.csv'.format(DATE, MICROSCOPE, TEMP, CARBON,
                                               OPERATOR))
snap_df.to_csv('output/{}_{}_{}C_{}_{}_snaps.csv'.format(DATE, MICROSCOPE, TEMP,
                                                         CARBON, MICROSCOPE,
                                                         TEMP, OPERATOR))
...
fc_df.to_csv('output/{}_{}_{}C_{}_{}_foldchange.csv'.format(DATE,
                                                            MICROSCOPE, TEMP, CARBON, OPERATOR), index=False)

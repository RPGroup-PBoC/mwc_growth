...
# 2019-03-06 37C Acetate O2 Dilution (Run 2)
...
## Notes & Observations
* Cells were harvested at OD_600nm between 0.18 and 0.25, except , except for `dilution` 3ng/mL and 7ng/mL, which were harvested at OD_600nm of 0.13 and 0.16 respectively.
* The `dilution` 10ng/mL sample was diluted 1.5x about 3.5 hours before harvesting.
...
3. Tubes were placed in a rack and covered with a plastic box to protect from photocleavage of ATC. Cells were allowed to grow for 23 hours at 37°C with shaking at ~ 220 RPM. After only ~19.5 hours, the `dilution` 10ng/mL sample was diluted 1:1.5 and returned to the shaker.

4. Once the cells reached an OD<sub>600nm</sub> between 0.13 - 0.25, the cells were removed from the warm room and harvested.

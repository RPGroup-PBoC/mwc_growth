...
# YEAR-MONTH-DATE TEMPERATURE CARBON OPERATOR Dilution
...
## Notes & Observations
* The `deltaLacI` strain, as is usually the case, grew more slowly than the other cultures. While all other cultures were harvested between OD_600nm_ ~ 0.2 and 0.3, the `deltaLacI` strain was harvested around 0.1. 
...
7. These were positions were imaged every 10 minutes for 4 hours using only the Brightfield channel. After this time lapse, these positions were imaged once more using a Brightfield, mCherry, and YFP channels.
